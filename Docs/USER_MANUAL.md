...
> _Manage your stable of warriors, train fighting styles, and compete in the arena!_
> Version 2.1.0
...
**Stable Lords** is a tactical management game set in a brutal arena world. You are the owner and strategist of a fighting _stable_ — a roster of warriors you recruit, train, equip, and send into the arena to earn fame and fortune.
...
### 3.1 Stable Progression & Win Condition
...
Six combat skills are _derived_ from attributes using the canonical Duelmasters breakpoint table. They range from **1** to **20**.
