        ...
        <div className="flex items-center justify-between">
          ...
          <div className="text-right flex items-center gap-6">
            ...
            <div className="text-right">
              <div
                className={cn(
                  'text-3xl font-display font-black tracking-tighter leading-none transition-all motion-reduce:transition-none motion-reduce:transform-none motion-reduce:transition-none motion-reduce:transform-none',
                  getScoreColor(score)
                )}
              >
                {score}
