...
const ARENA_STYLES: Record<ArenaTier, ArenaStyle> = {
  training: {
    name: 'Training Pit',
    floor: 'linear-gradient(180deg, hsl(var(--background)) 0%, hsl(var(--muted)) 100%)',
    wall: 'hsl(var(--border))',
  ...
  standard: {
    name: 'Arena',
    floor: 'linear-gradient(180deg, hsl(var(--arena-gold)) 0%, hsl(var(--arena-gold)) 100%)',
    wall: 'hsl(var(--background))',
    accent: 'hsl(var(--arena-fame))',
    crowd: true,
    crowdDensity: 'sparse',
...
> = {
  spring: {
    ...
    accentColor: 'hsl(var(--arena-fame))',
    decorations: true,
  },
  summer: {
    wallOverlay: 'rgba(255, 215, 0, 0.1)',
    accentColor: 'hsl(var(--arena-gold))',
    decorations: true,
  },
  fall: {
  ...
  winter: {
    ...
    accentColor: 'hsl(var(--arena-bone))',
    decorations: false,
  },
  tournament: {
