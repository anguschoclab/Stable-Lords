...
export default function MiniCombatLog({
  ...
  return (
    <div className={cn('absolute bottom-4 left-4 z-30', 'transition-all motion-reduce:transition-none motion-reduce:transform-none duration-300 motion-reduce:transition-none', className)}>
      {/* Header */}
      <div
        role="button"
        tabIndex={0}
                ...
                return (
                  <div
                    ...
                    className={cn(
                      ...
                      'transition-all motion-reduce:transition-none motion-reduce:transform-none duration-300 motion-reduce:transition-none',
                      isLatest && 'bg-white/5'
                    )}
                  >
