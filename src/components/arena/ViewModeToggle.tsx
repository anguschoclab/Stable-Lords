  ...
  return (
    ...
    >
      <button
        ...
        className={cn(
          'flex items-center gap-2 px-3 py-1.5 text-xs font-bold uppercase tracking-wider transition-all motion-reduce:transition-none motion-reduce:transform-none motion-reduce:transition-none outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-inset',
          mode === 'log'
