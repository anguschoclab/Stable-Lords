...
export function BookmarkButton({
  ...
  return (
    <button
      ...
      className={cn(
        'p-1.5 rounded-none border transition-all motion-reduce:transition-none motion-reduce:transform-none motion-reduce:transition-none motion-reduce:transform-none duration-200 shrink-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-inset',
        isBookmarked
