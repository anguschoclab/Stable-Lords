  ...
  return (
    <Tooltip>
      <TooltipTrigger asChild>
        <div
          className={cn(
            'absolute w-3 h-3 rounded-none -translate-x-1/2 -translate-y-1/2 cursor-default transition-transform hover:scale-150 motion-reduce:transition-none motion-reduce:transform-none',
            dot.isPlayer
