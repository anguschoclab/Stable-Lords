          ...
          return (
            <div key={row.style} className="flex items-center gap-3">
              ...
              <div className="flex-1 h-1.5 bg-white/5 rounded-none overflow-hidden">
                <div
                  className={cn('h-full rounded-none transition-all motion-reduce:transition-none motion-reduce:transform-none motion-reduce:transition-none motion-reduce:transform-none duration-500', barColor)}
                  style={{ width: `${pct}%` }}
                />
              </div>
              <div
