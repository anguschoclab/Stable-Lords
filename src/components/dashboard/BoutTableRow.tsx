      ...
      <TableCell className="text-center py-4">
        <Tooltip>
          <TooltipTrigger asChild>
            <div
              className={cn(
                'inline-flex items-center gap-2 px-3 py-1 rounded-none border font-black text-[9px] tracking-[0.2em] uppercase transition-all motion-reduce:transition-none motion-reduce:transform-none motion-reduce:transition-none motion-reduce:transform-none',
                playerWon
