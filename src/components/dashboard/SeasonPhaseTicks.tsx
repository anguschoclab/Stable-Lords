          ...
          return (
            <div key={week} className="relative flex flex-col items-center flex-1">
              ...
              <div
                ...
                className={cn(
                  'h-2 w-full rounded-none transition-all motion-reduce:transition-none motion-reduce:transform-none motion-reduce:transition-none motion-reduce:transform-none duration-300',
                  isActive
