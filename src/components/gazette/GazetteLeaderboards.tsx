      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 relative z-10">
        {bestData.map((d) => (
          <Surface
            ...
            variant="paper"
            padding="sm"
            className="bg-white/[0.02] border-white/5 group hover:border-arena-gold/30 transition-all motion-reduce:transition-none motion-reduce:transform-none"
          >
        ...
        {stars.length === 0 ? (
          ...
          stars.map((s) => (
            <Surface
              ...
              variant="paper"
              padding="sm"
              className="bg-primary/5 border border-primary/10 group hover:border-primary/40 transition-all motion-reduce:transition-none motion-reduce:transform-none"
            >
              <div className="flex justify-between items-center">
                <div className="flex flex-col">
