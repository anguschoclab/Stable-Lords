        ...
        return (
          <LinkComponent
            ...
            className={cn(
              ...
              'text-[11px] font-black uppercase tracking-widest transition-all motion-reduce:transition-none motion-reduce:transform-none motion-reduce:transition-none motion-reduce:transform-none duration-150',
              isActive
            ...
            return (
              <LinkComponent
                ...
                className={cn(
                  ...
                  'text-[10px] font-black uppercase tracking-wider transition-all motion-reduce:transition-none motion-reduce:transform-none motion-reduce:transition-none motion-reduce:transform-none duration-150 group',
                  isActive
