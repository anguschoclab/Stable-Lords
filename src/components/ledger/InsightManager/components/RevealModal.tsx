...
export function RevealModal({ data, onClose }: RevealModalProps) {
  ...
  return (
    <AnimatePresence>
      ...
      >
        <div className="bg-neutral-950 border-2 border-primary/40 rounded-none p-10 max-w-md w-full text-center relative shadow-[0_0_50px_hsl(var(--destructive)/0.2)]">
          <div className="absolute -top-6 left-1/2 -translate-x-1/2 w-12 h-12 rounded-none bg-primary flex items-center justify-center shadow-[0_0_20px_hsl(var(--destructive)/0.5)]">
            <Sparkles />
          </div>
