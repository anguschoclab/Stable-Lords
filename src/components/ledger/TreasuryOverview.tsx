...
function FiscalTrajectoryMonitor({ breakdown, week }: FiscalTrajectoryMonitorProps) {
  return (
    <Surface
      variant="glass"
...
function LedgerRegistry({ recentLedger, totalLedgerEntries }: LedgerRegistryProps) {
  return (
    <Surface
      variant="glass"
      padding="none"
    ...
    >
      <div className="p-8 border-b border-white/5 bg-background/90 flex items-center justify-between">
