...
export function DeathModalPaperDoll() {
  return (
    <div className="flex justify-center bg-black/40 rounded-none p-4 border border-white/5 relative group">
      <div className="absolute inset-0 bg-arena-blood/5 opacity-0 group-hover:opacity-100 transition-opacity blur-xl rounded-none motion-reduce:transition-none" />
