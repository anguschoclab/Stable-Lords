            ...
            {PLAN_TACTICS.map((t) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    'flex items-center gap-2 p-3 text-xs font-bold uppercase tracking-wider border transition-all motion-reduce:transition-none motion-reduce:transform-none motion-reduce:transition-none motion-reduce:transform-none duration-200 text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-inset',
                    isActive
