...
export default function WarriorCard({ warrior, isSelected, canSelect, onClick }: WarriorCardProps) {
  ...
  return (
    <div
      ...
      className={`relative cursor-pointer transition-all motion-reduce:transition-none motion-reduce:transform-none motion-reduce:transition-none motion-reduce:transform-none duration-200 group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-1 focus-visible:ring-offset-black ${
