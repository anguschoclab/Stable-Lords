      ...
      <div className="flex flex-col gap-2 p-2 bg-black/40 border border-white/5 rounded-none">
        {TACTIC_BANK.map((t) => (
          <button
            ...
            className={cn(
              'flex items-center gap-3 p-3 text-xs font-bold uppercase tracking-wider border transition-all motion-reduce:transition-none motion-reduce:transform-none motion-reduce:transition-none motion-reduce:transform-none duration-200 text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-inset',
              plan &&
