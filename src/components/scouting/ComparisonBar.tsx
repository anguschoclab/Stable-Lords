        ...
        <div className="flex-1 flex justify-end">
          <div className="h-1.5 bg-secondary/30 rounded-full overflow-hidden w-full flex justify-end">
            <motion.div
              ...
              animate={{ width: `${pctA}%` }}
              className={cn(
                'h-full rounded-full transition-all motion-reduce:transition-none motion-reduce:transform-none motion-reduce:transition-none motion-reduce:transform-none',
                colorA,
