  ...
  if (!lineage) {
    return (
      <Surface variant="glass" className="p-8 text-center border-dashed border-white/5 opacity-40">
        ...
        <p className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground">No Lineage Data Detected</p>
        <p className="text-[9px] italic text-muted-foreground/60 mt-2">Commoner status // Identity verified as first-generation combatant.</p>
      </Surface>
    );
  }
        ...
        <div className="p-6 space-y-8">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h4 className="text-[11px] font-black uppercase tracking-[0.2em]">Genealogical Trace</h4>
                <p className="text-[9px] font-mono text-muted-foreground opacity-60 uppercase">Protocol: Inheritance_Verify // Gen: {lineage.generation}</p>
              </div>
            </div>
            <div className={cn(
          ...
          <div className="flex flex-col items-center gap-12 py-4">
            ...
            <div className="relative group">
              ...
              <div className="relative p-4 border border-white/10 bg-neutral-900/80 w-48 text-center transition-all group-hover:border-primary/40">
                ...
                <p className="text-[8px] font-black text-muted-foreground uppercase tracking-widest mb-1">Source Ancestor</p>
            ...
            <div className="relative">
              ...
              <div className="relative p-6 border-2 border-arena-gold/30 bg-neutral-900 shadow-[0_0_30px_rgba(255,215,0,0.1)] w-56 text-center">
                ...
                <p className="text-[9px] font-black text-arena-gold uppercase tracking-[0.3em] mb-1">Current Subject</p>
                ...
                <div className="mt-3 flex justify-center gap-1">
                   {[...Array(lineage.generation)].map((_, i) => (
                     <div key={i} className="w-2 h-2 border border-arena-gold/40 bg-arena-gold/10 rotate-45" />
                   ))}
                </div>
              </div>
            </div>
          ...
          <div className="pt-4 border-t border-white/5 flex justify-between items-center opacity-40">
            <span className="text-[8px] font-mono uppercase tracking-widest text-muted-foreground">ID: {lineage.parentId?.slice(0, 8)}...</span>
            <span className="text-[8px] font-mono uppercase tracking-widest text-muted-foreground">SYNC_COMPLETE</span>
          </div>
        </div>
      </Surface>
    </div>
