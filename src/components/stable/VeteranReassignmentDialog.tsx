...
export function VeteranReassignmentDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent aria-describedby="veteran-dialog-description" className="bg-neutral-950/95 backdrop-blur-2xl border-white/10 sm:max-w-2xl max-h-[80vh] overflow-hidden flex flex-col p-0 rounded-none">
        <DialogTitle className="sr-only">Veteran Reassignment</DialogTitle>
        <DialogDescription id="veteran-dialog-description" className="sr-only">Assign veterans as staff</DialogDescription>
