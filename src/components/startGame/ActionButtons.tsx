  ...
  return (
    <div className="space-y-2.5">
      ...
      <Button
        ...
        className="w-full flex items-center justify-center gap-2 h-9 text-[10px] font-black uppercase tracking-widest text-muted-foreground/70 hover:text-foreground hover:bg-white/5 transition-colors duration-150 motion-reduce:transition-none"
      >
