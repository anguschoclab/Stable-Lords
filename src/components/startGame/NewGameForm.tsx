      ...
      <div className="relative z-10 w-full max-w-xl space-y-6">
        ...
        >
          ...
          <Button
            ...
            className="w-full h-10 gap-2 border-border/80 bg-background hover:border-accent/40 hover:bg-accent/5 text-[11px] font-black uppercase tracking-wider"
          >
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <Input
                  ...
                  maxLength={24}
                  autoFocus
                  className="flex-1 h-10 text-sm bg-background border-border/80 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/40 focus-visible:ring-offset-2"
                />
                <Button
                  variant="outline"
                  size="icon"
                  ...
                  className="h-10 w-10 shrink-0 border-border/80 bg-background hover:border-accent/40 hover:bg-accent/5"
                >
                  <Dices className="h-4 w-4 text-accent/70" />
                </Button>
              </div>
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <Button
                  ...
                  className="h-9 px-4 gap-2 border-border/80 bg-background hover:border-accent/40 hover:bg-accent/5 text-[11px] font-black uppercase tracking-wider"
                >
                  <Dices className="h-4 w-4 text-accent/70" />
                  RANDOMIZE HERALDRY
                </Button>
