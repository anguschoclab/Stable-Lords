...
export function BracketMatchNode({
  ...
  return (
    <div className={cn('relative group', bronze && 'opacity-90')}>
      ...
      <div
        className={cn(
          'w-64 rounded-none border transition-all motion-reduce:transition-none motion-reduce:transform-none motion-reduce:transition-none motion-reduce:transform-none duration-300 relative z-10',
          isPending
