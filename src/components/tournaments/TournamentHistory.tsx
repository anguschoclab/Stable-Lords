      ...
      {['Spring', 'Summer', 'Fall', 'Winter'].map((s) => {
        ...
        return (
          <Surface
            ...
            padding="none"
            className={cn(
              'transition-all motion-reduce:transition-none motion-reduce:transform-none motion-reduce:transition-none motion-reduce:transform-none duration-500 overflow-hidden relative group',
