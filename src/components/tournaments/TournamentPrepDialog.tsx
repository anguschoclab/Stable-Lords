...
export function TournamentPrepDialog({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent
        aria-describedby="tournament-prep-description"
        className="max-w-2xl bg-neutral-950/90 backdrop-blur-xl border-white/10 shadow-2xl p-0 overflow-hidden"
      >
        <DialogTitle className="sr-only">Tournament Preparation</DialogTitle>
        <DialogDescription id="tournament-prep-description" className="sr-only">
