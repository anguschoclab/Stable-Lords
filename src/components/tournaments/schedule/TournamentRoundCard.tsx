...
export function TournamentRoundCard({
  ...
  return (
    <Card
      className={cn(
        'overflow-hidden transition-all motion-reduce:transition-none motion-reduce:transform-none motion-reduce:transition-none motion-reduce:transform-none duration-300',
