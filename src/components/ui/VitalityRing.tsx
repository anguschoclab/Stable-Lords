    ...
    <div className={cn('relative inline-flex items-center justify-center', className)}>
      ...
      >
        ...
        <circle
          ...
          r={radius}
          fill="none"
          className={cn('transition-all motion-reduce:transition-none motion-reduce:transform-none motion-reduce:transition-none motion-reduce:transform-none duration-700', strokeClass)}
          strokeWidth={strokeWidth}
