...
export function MissionControlTab({ 
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
       <div className="bg-glass-card border-neon-gold border-2 rounded-none overflow-hidden shadow-2xl">
       ...
       <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="bg-glass-card border-neon rounded-none overflow-hidden border">
