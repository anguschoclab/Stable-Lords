        ...
        .map((f) => {
          ...
          return (
            ...
            >
              <button
                className={cn(
                  'w-full flex items-center justify-between py-2.5 px-3 transition-colors text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-inset motion-reduce:transition-none',
