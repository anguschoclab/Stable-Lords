      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {[
          ...
          <Surface key={stat.label} variant="glass" className="p-6 border-white/5">
            <div className="text-[8px] font-black uppercase tracking-widest text-muted-foreground/40 mb-1">{stat.sub}</div>
            <div className="text-[10px] font-black uppercase tracking-widest text-foreground mb-4">{stat.label}</div>
