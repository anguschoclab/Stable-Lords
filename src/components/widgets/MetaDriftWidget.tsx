            ...
            return (
              <div key={item.style} className="group">
                ...
                <div className="relative h-1 w-full bg-white/5 overflow-hidden">
                  <div
                    className={cn(
                      'absolute h-full transition-all motion-reduce:transition-none motion-reduce:transform-none motion-reduce:transition-none motion-reduce:transform-none duration-1000',
                      isPositive
