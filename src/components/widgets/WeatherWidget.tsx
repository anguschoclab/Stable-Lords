    ...
    <Surface variant="glass" className="h-full flex flex-col p-5 border-l-4 border-l-primary animate-in fade-in zoom-in-95 duration-500 delay-100">
      ...
      <div className="flex items-center justify-between mb-4">
         ...
         <div className="text-right">
           ...
           <p className="text-[10px] text-muted-foreground italic leading-tight max-w-[8.75rem] border-r-2 border-primary/20 pr-3">
             {meta.description}
           </p>
         </div>
      </div>
      ...
      <div className="mt-auto pt-2">
        <TooltipProvider>
          <Tooltip>
            ...
            <TooltipContent className="bg-black/90 border-white/10 p-3 max-w-xs">
