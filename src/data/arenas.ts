...
export const ARENA_LORE: ArenaLoreEntry[] = [

  {
    ...
    narrative: 'A massacre where gladiators turned on their masters, painting the sand red.',
  },
  {
    id: 'standard_arena_iron_gate',
    arenaId: 'standard_arena',
    type: 'architectural_quirk',
    title: 'The Rusting Gate',
    narrative: 'The main gate was forged from the weapons of fallen combatants.',
  },  {
