...
const WEATHER_OPENING_LINES: Record<WeatherType, string | null> = {
  ...
  'Winds of Chaos':
    'Unpredictable magical gales whip through the arena, carrying the scent of ozone and madness.',
  'Rain of Frogs':
  ...
  'Dreamweavers Mist':
    'A surreal, hallucinogenic mist envelops the arena, distorting senses and lulling the crowd.',
