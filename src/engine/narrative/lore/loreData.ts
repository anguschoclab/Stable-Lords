...
export const ORIGINS: string[] = [
  ...
  'Raised in the suffocating shadows of the Gloom-Spire Orphanage',
  'Abandoned amidst the skeletal remains of the Iron-Tooth Canyons',
  'Survived the vicious rat-fighting rings of the Sunless Wards',
  'Sold by indebted kin to the merciless overseers of the Salt Mines',
  'Found clutching a broken locket in the ashes of the Burned District',
  'Abandoned to the feral packs roaming the Forgotten Docks',
  'Survived the plague-ridden quarantines of the Weeping Slums',
  "Born in the rusted iron cages of the Beast-Tamer's Guild",
  'Found shivering in the forgotten, flooded catacombs of the Old City',
];
...
export const CHILDHOOD_TRAITS: string[] = [
  ...
  "was known for setting traps that even the elder wardens couldn't detect",
  'would chew on rusted iron to test the strength of their teeth',
  'learned to move with absolute silence by stalking the feral cats of the alleys',
  'would paint grim murals using the soot from the orphanage hearth',
  'never showed pain, only a cold, terrifying smile when struck',
];
...
export const DEFINING_MOMENTS: string[] = [
  ...
  'until they choked a corrupt taskmaster with their bare, bloodied hands',
  'knowing that the deafening roar of the arena was the only truth left',
  'until they turned a discarded, rusted chain into an instrument of vengeance',
  'waiting for the moment they could carve their name into the flesh of the nobility',
];
