...
export const ORIGINS: string[] = [
  ...
  'Born in the sunless undercroft of the Asylum of the Broken Saint',
  'Abandoned in a basket woven from razor-vine in the Crawling Slums',
  'Discovered swaddled in blood-soaked rags at the steps of the Charnel House',
  'Raised by the blind morticians of the Silent Crypts',
  'Found gnawing on bones in the ash pits behind the Great Crematorium',
  'Left to freeze on the frost-choked gargoyles of the Black Spire Orphanage',
  'Traded for a flask of cheap gin at the Night Market of Sorrows',
];
...
export const CHILDHOOD_TRAITS: string[] = [
  ...
  'would obsessively collect the teeth of fallen street brawlers',
  "developed a hauntingly accurate imitation of a dying man's rattle",
  'never blinked when the orphanage matron threatened the cane',
  'learned to fashion crude shivs from the splintered floorboards',
];
...
export const DEFINING_MOMENTS: string[] = [
  ...
  'until the day they drowned the abusive headmaster in the orphanage wash-basin',
  'realizing that the only true warmth in the world comes from freshly spilled blood',
  'waiting for the arena doors to open so they can introduce the nobility to the gutter',
  "understanding that pain is just weakness leaving the body, usually someone else's",
  "until they shattered a slaver's jaw and stepped into the bloody sands of freedom",
];
