...
'Abandoned at the rusted gates of the Weeping Mother Orphanage',
  ...
  'Raised in the echoing halls of the Silent Monastery',
  'Escaped the flesh-markets of the Crimson Coast',
  'Found wandering the desolate Glass Wastes with no memory of their name',
  'Born during the Blood Moon in the forgotten catacombs of the old kings',
  'Survived a massacre in the Howling Mountains by hiding beneath the slain',
  'Torn from a cult dedicated to the forgotten gods of the abyss'
];
...
'would collect shattered teeth from the fighting pits as grim trophies',
  ...
  'would carve intricate tallies of imaginary victories into the orphanage walls',
  'learned the anatomy of survival by dissecting predators found in the undercity',
  'developed a terrifyingly silent footstep to evade the cruel matrons',
  'slept peacefully through the deafening roar of the adjacent fighting pits'
];
...
'strangled a corrupt guard with their own rusted chains to escape confinement',
  ...
  'until they watched their only friend die for a handful of copper coins and learned not to weep',
  'realizing that a life lived in the shadows is merely a slow, creeping death',
  'transforming years of quiet abuse into a singular, razor-sharp focus for survival'
];
