...
const ORIGINS = [
  ...
  'Discarded in the soot-stained flues of the Black Iron Foundry',
  'Survived the squalid pens of the Weeping Sisters\' Orphanage',
  'Raised in darkness within the collapsed cellars of the Ashen Cathedral',
  'Left bound and shivering outside the gates of the Bleakhouse Asylum',
  'Scavenged a bloody living from the festering gutters of the Slaughter Wards',
...
const CHILDHOOD_TRAITS = [
  ...
  'would deliberately catch venomous spiders to study their lethal patience',
  'developed a chillingly quiet breathing technique to evade detection in the dark',
  'learned to identify a liar by the subtle shift in their footing',
...
const DEFINING_MOMENTS = [
  ...
  'until the night they strangled a corrupt warden and stepped out of the shadows',
  'knowing that the roar of the arena is simply the sound of survival',
  'waiting for the singular moment they could drown their past in glorious violence',
