...
import {
  ...
  szMod,
  ST_ATT, ST_PAR,
  WT_ATT, WT_DEF, WT_INI, WT_RIP, WT_DEC,
  WL_ATT, WL_PAR, WL_DEF, WL_DEC,
  SP_DEC, SP_DEF, SP_INI, SP_RIP,
  DF_ATT, DF_DEF, DF_INI, DF_PAR, DF_RIP,
  SZ_INI_MOD, SZ_PAR_MOD, SZ_DEF_MOD,
  STYLE_PENALTIES,
