...
export const TRAITS: Record<string, TraitDef> = {
  ...
  pit_rat: {
    id: 'pit_rat',
    name: 'Pit Rat',
    description: '+1 Initiative, +1 Defense in the OPENING phase — raised in the gutters, they strike fast and slip away before retaliation.',
    effect: { iniMod: 1, defModEarly: 1, fightPlanMod: { AL: 1, feintTendency: 1 } },
    weight: 0.6,
    synergy: ['agile', 'cunning'],
    antiSynergy: ['tank'],
    tier: 'Notable',
  ...
  orphan_fury: {
    id: 'orphan_fury',
    name: 'Orphan Fury',
    description: '+2 Attack when bloodied (HP < 50%), but -1 Defense — channels a lifetime of neglect into reckless, desperate violence.',
    effect: { attModLowHp: 2, defMod: -1, fightPlanMod: { killDesire: 2, OE: 1 } },
    weight: 0.5,
    synergy: ['brutal'],
    antiSynergy: ['cunning'],
    tier: 'Notable',
  ...
  cold_veins: {
    id: 'cold_veins',
    name: 'Cold Veins',
    description: '+1 Decisiveness, +1 Parry in the LATE phase — unaffected by pain or exhaustion, maintaining perfect composure.',
    effect: { decMod: 1, parModLate: 1, fightPlanMod: { AL: -1 } },
    weight: 0.5,
    synergy: ['tank', 'cunning'],
    antiSynergy: ['agile'],
    tier: 'Notable',
    sign: 'positive',
  },
