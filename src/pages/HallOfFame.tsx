...
import { Crown, Skull, Swords, Trophy, Star, Shield, Flame } from "lucide-react";
...
function winnerName(f: FightSummary) {
  return f.winner === "A" ? f.a : f.winner === "D" ? f.d : "Draw";
}

/* ── Inductee Card ───────────────────────────────────────── */

function InducteeCard({ warrior, title, icon, fights }: { warrior: Warrior; title: string; icon: React.ReactNode; fights: FightSummary[] }) {
