...
describe('runSeasonalPass', () => {
  ...
  it('should trigger the black_market_raid offseason event, deduct gold, and newsletter', () => {
    ...
    const mockNext = () => {
      callCount++;
      if (callCount === 1) return 8.5 / 14; // picks index 8 = black_market_raid
      return originalNext();
    };
  ...
  it('should trigger the grand_feast offseason event, deduct gold, award XP to all active', () => {
    ...
    const mockNext = () => {
      callCount++;
      if (callCount === 1) return 9.5 / 14; // picks index 9 = grand_feast
      return originalNext();
    };
    (rng as any).rng.next = mockNext;
  ...
  it('should trigger the tavern_brawl offseason event, award fame, and add a Bruised Ribs injury', () => {
    ...
    const mockNext = () => {
      callCount++;
      if (callCount === 1) return 5.5 / 14; // picks index 5 = tavern_brawl
      return originalNext();
    };
    (rng as any).rng.next = mockNext;
  ...
  it('should not add a Bruised Ribs injury to an already-injured warrior in tavern_brawl', () => {
    ...
    const mockNext = () => {
      callCount++;
      if (callCount === 1) return 5.5 / 14; // picks tavern_brawl
      return originalNext();
    };
    (rng as any).rng.next = mockNext;
  ...
  it('should trigger wandering_healer and cure an injury if someone is injured', () => {
    ...
    const mockNext = () => {
      callCount++;
      if (callCount === 1) return 10.5 / 14; // picks index 10 = wandering_healer
      return originalNext();
    };
    (rng as any).rng.next = mockNext;
  ...
  it('should trigger the mystic_vision offseason event, award xp and fame, and add a newsletter item', () => {
    ...
    const mockNext = () => {
      callCount++;
      if (callCount === 1) return 11.5 / 14; // picks index 11 = mystic_vision
      return originalNext();
    };
    (rng as any).rng.next = mockNext;
  ...
  it('should trigger the wild_animal_attack offseason event, award fame, and add a Bite Wound injury', () => {
    ...
    const mockNext = () => {
      callCount++;
      if (callCount === 1) return 12.5 / 14; // picks index 12 = wild_animal_attack
      return originalNext();
    };
    (rng as any).rng.next = mockNext;
  ...
  it('should trigger the loyal_stray offseason event, award xp and fame, and deduct gold', () => {
    ...
    const mockNext = () => {
      callCount++;
      if (callCount === 1) return 13.5 / 14; // picks index 13 = loyal_stray
      return originalNext();
    };
    (rng as any).rng.next = mockNext;
