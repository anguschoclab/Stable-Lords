...
const EXPECTED_COUNT = 142; // 100 baseline + 20 new traits + 3 from #769 + 5 from refactor + 4 from #788 + 3 from #784 + 3 narrative traits + 1 gutter_shadow + 3 from lore expansion
