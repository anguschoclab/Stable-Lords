...
const EXPECTED_COUNT = BASELINE_COUNT - REMOVED_IDS.length + 2;
...
describe('Trait deduplication', () => {
  ...
  describe('trait count decreased by exactly 12', () => {
    it(`TRAITS has ${EXPECTED_COUNT} entries (was ${BASELINE_COUNT})`, () => {
