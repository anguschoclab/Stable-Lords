    ...
    const { result } = renderHook(() =>
      useDigestSummary({
        ...
        boutOffers: {
          ...
          ['offer-2' as BoutOfferId]: makeOffer({
            status: 'Proposed',
            boutWeek: 11,
            warriorIds: ['wc' as WarriorId],
          }),
          ['offer-3' as BoutOfferId]: makeOffer({
            status: 'Proposed',
            boutWeek: 9,
            warriorIds: ['wa' as WarriorId],
          }),
  ...
  it('ignores Proposed offers with boutWeek < currentWeek', () => {
    const { result } = renderHook(() =>
      useDigestSummary({
        arenaHistory: [],
        boutOffers: {
          ['offer-1' as BoutOfferId]: makeOffer({ status: 'Proposed', boutWeek: 9 }),
        },
        currentWeek,
        playerWarriorIds,
      })
  ...
  it('counts Signed offers with boutWeek === currentWeek as signed', () => {
    const { result } = renderHook(() =>
      useDigestSummary({
        arenaHistory: [],
        boutOffers: {
          ['offer-1' as BoutOfferId]: makeOffer({ status: 'Signed', boutWeek: 10, warriorIds: ['wa' as WarriorId] }),
        },
        currentWeek,
        playerWarriorIds,
      })
  ...
  it('counts Signed offers with boutWeek > currentWeek as upcoming', () => {
    const { result } = renderHook(() =>
      useDigestSummary({
        arenaHistory: [],
        boutOffers: {
          ['offer-1' as BoutOfferId]: makeOffer({ status: 'Signed', boutWeek: 12, warriorIds: ['wa' as WarriorId] }),
          ['offer-2' as BoutOfferId]: makeOffer({ status: 'Signed', boutWeek: 15, warriorIds: ['wa' as WarriorId] }),
        },
        currentWeek,
        playerWarriorIds,
      })
  ...
  it('returns tournamentActive as false regardless of inputs', () => {
    const { result } = renderHook(() =>
      useDigestSummary({
        ...
        boutOffers: { ['o1' as BoutOfferId]: makeOffer() },
        currentWeek,
        playerWarriorIds,
      })
    );
  ...
  it('ignores Signed offers with boutWeek < currentWeek', () => {
    const { result } = renderHook(() =>
      useDigestSummary({
        arenaHistory: [],
        boutOffers: {
          ['offer-1' as BoutOfferId]: makeOffer({ status: 'Signed', boutWeek: 9 }),
        },
        currentWeek,
        playerWarriorIds,
      })
