...
// Mutate a store field and re-sync the real store (replaces direct
// mockStoreState.X assignments so closures and selectors stay consistent).
...
describe('Bookmarks Page', () => {
  ...
  it('shows Clear All button when bookmarks exist', () => {
    setStore({ bookmarks: [{ entityType: 'warrior', entityId: 'w1', createdAt: '2026-01-01' }] });
